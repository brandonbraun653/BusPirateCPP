...
Chimera::Serial::Status SerialDriver::setMode( const Chimera::Serial::SubPeripheral periph, const Chimera::Serial::Modes mode )
{
  throw std::logic_error( "The method or operation is not implemented." );
}
...
bool SerialDriver::reserve( const uint32_t timeout_mS )
{
  throw std::logic_error( "The method or operation is not implemented." );
}

bool SerialDriver::release( const uint32_t timeout_mS )
{
  throw std::logic_error( "The method or operation is not implemented." );
}
